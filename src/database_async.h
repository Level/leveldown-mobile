...
class OpenWorker : public AsyncWorker {
 public:
  OpenWorker(Database *database, NanCallback *callback,
             leveldb::Cache *blockCache,
             const leveldb::FilterPolicy *filterPolicy, bool createIfMissing,
...
class CloseWorker : public AsyncWorker {
 public:
  CloseWorker(Database *database, NanCallback *callback);
...
class IOWorker : public AsyncWorker {
 public:
  IOWorker(Database *database, NanCallback *callback, leveldb::Slice key,
...
class ReadWorker : public IOWorker {
 public:
  ReadWorker(Database *database, NanCallback *callback, leveldb::Slice key,
             bool asBuffer, bool fillCache, JS_LOCAL_OBJECT &keyHandle);
...
class DeleteWorker : public IOWorker {
 public:
  DeleteWorker(Database *database, NanCallback *callback, leveldb::Slice key,
               bool sync, JS_LOCAL_OBJECT &keyHandle);
...
class WriteWorker : public DeleteWorker {
 public:
  WriteWorker(Database *database, NanCallback *callback, leveldb::Slice key,
              leveldb::Slice value, bool sync, JS_LOCAL_OBJECT &keyHandle,
...
class BatchWorker : public AsyncWorker {
 public:
  BatchWorker(Database *database, NanCallback *callback,
...
class ApproximateSizeWorker : public AsyncWorker {
 public:
  ApproximateSizeWorker(Database *database, NanCallback *callback,
                        leveldb::Slice start, leveldb::Slice end,
